        ...
        Synth.prototype.stopNote = function (note) {
            ...
            for (var i = 0; i < this.activeOscillators.length; i++) {
                ...
                if (match) {
                    ...
                    this.activeVolumeEnvelopes[i].stop(timeToStop + this.volumeEnvelopeSettings.releaseTime);
                    this.activeVolumeEnvelopes.splice(i,1);

                    this.activeFilterEnvelopes[i].stop(timeToStop + this.filterEnvelopeSettings.releaseTime);
